...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { cel: @pessoa.cel, cpf: @pessoa.cpf, email: @pessoa.email, nome: @pessoa.nome, proprietario: @pessoa.proprietario }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { cel: @pessoa.cel, cpf: @pessoa.cpf, email: @pessoa.email, nome: @pessoa.nome, proprietario: @pessoa.proprietario }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
